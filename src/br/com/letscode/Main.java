...
////        String operation;
////
////        System.out.println("Enter 'number' 'operation' 'number'");
...
//        number = input.nextDouble();
//
//        System.out.println(convertCelsiusToFahrenheit(number));
//
//    }
//
...
//        double realValue;
//
//        System.out.println("digite o valor em R$ a ser convertido pra US$");
//        realValue = input.nextDouble();
//
//        System.out.printf("R$ %.2f em dólar: US$ %.2f", realValue, dolarConverter(realValue));
//
//
//    }
//
//    public static double dolarConverter(double realValue) {
//        return realValue / 5.53;
//    }
...
//        Scanner input = new Scanner(System.in);
//
//        System.out.println("Type a inch measure to convert to centimeters");
//        inches = input.nextDouble();
//
//        System.out.printf("%.2f inches to centimeters: %.2f cm", inches, inchToNotStupidMeasuringSystemConverter(inches));
//
//        input.close();
//
//    }
